...
(* This file considers unemployment probability shocks and computes the consumption and wealth paths of an economy in which there's two groups of people with different degrees of impatience, one with discount factor 1/1.047
...
PathAfterUrateChange=ShowLegend[Show[
...
LegendPosition->{0.05,0.25},LegendSize->{0.6,0.25}}
];
Export[figuredirectory<>"PathAfterUrateChange.eps",PathAfterUrateChange];
