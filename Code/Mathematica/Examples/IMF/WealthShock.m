...
(* This file considers wealth shocks and computes the consumption and wealth paths of an economy in which there are two groups of people with different degrees of impatience, one with discount factor 1/1.047
...
Needs["PlotLegends`"];
PathAfterWealthShock=ShowLegend[Show[
...
Export[figuredirectory<>"PathAfterWealthShock.eps",PathAfterWealthShock];
